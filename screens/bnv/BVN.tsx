  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Text style={[GET_STARTED, { color: isDarkMode ? colors.white : colors.companyBlue }]}>
      ...
      <View style={ROOT}>
        <ScrollView>
          <ImageBackground source={isDarkMode ? images.darkBackground : images.backgroundImage} style={BACKGROUND_IMAGE}>
            <View
              style={{
                justifyContent: "center",
                alignItems: "center",
            ...
            >
              ...
              <View
                style={[
                  tw`flex flex-row `,
                  {
                    ...
                    backgroundColor: colors.textFieldBGColor || colors.white,
                    height: 50,
              ...
              >
                ...
                >
                  <Ionicons name={passwordHidden ? "eye-off" : "eye"} size={20} color={"grey"} />
                </TouchableOpacity>
              </View>

              <TouchableOpacity onPress={() => setShowResetEmail(true)}>
                <Text style={[GET_STARTED, { color: isDarkMode ? colors.white : colors.companyBlue }]}>
              ...
              <TouchableOpacity onPress={() => setShowRegister(true)}>
                <Text style={[GET_STARTED2, { color: isDarkMode ? colors.white : colors.companyBlue }]}>
      ...
      <Modal isVisible={showRegister} onBackButtonPress={() => setShowRegister(false)} style={{ backgroundColor: "white" }}>
        <View style={{ flex: 1 }}>
          <Text style={[GET_STARTED3, { color: isDarkMode ? colors.white : colors.companyBlue }]}>Register as a new Rider</Text>
          <View
            style={{
              padding: 20,
              paddingTop: 10,
