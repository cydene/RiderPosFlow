...
// react-native
import {
	View, ViewStyle, StatusBar, TextStyle, Text, Keyboard, Platform
} from "react-native";
...
const EditProfile = (props: Props) => {
    const { oldAccountNumber, oldBankName, userDetails, isLoading, isOnline, notificationId, navigation, firstName, lastName, phone, updateUserProfileAsync } = props
...
if(coming=='Zenith bank PLC')
{
    ...
    const banksList2 = [
      ...
      const banks = [
        ...
        {'id': 10, 'code': '090268',"label": 'Adeyemi College Staff Microfinance Bank', "value": 'Adeyemi College Staff Microfinance Bank'},
        ...
        {'id': 37, 'code': '100032',"label": 'Contec Global Infotech Limited (NowNow)', "value": 'Contec Global Infotech Limited (NowNow)'},
        ...
        {'id': 70, 'code': '110002', "label": 'Flutterwave Technology Solutions Limited',"value": 'Flutterwave Technology Solutions Limited'},
                ...
                >
                    ...
                    >
                        ...
                        <Text
                            style={SETTINGS_TITLE}
                        >
                            {translate('profile.accountNumber')}
                        </Text>
